...
@implementation PlayFabInsightsAPI
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                InsightsInsightsGetDetailsResponse *model = [[InsightsInsightsGetDetailsResponse new] initWithDictionary:class_data];
...
-(void) GetLimits:(InsightsInsightsEmptyRequest*)request success:(GetLimitsCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                InsightsInsightsGetLimitsResponse *model = [[InsightsInsightsGetLimitsResponse new] initWithDictionary:class_data];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Insights/GetLimits"] body:jsonString authType:nil authKey:nil];
}
-(void) GetOperationStatus:(InsightsInsightsGetOperationStatusRequest*)request success:(GetOperationStatusCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[InsightsInsightsGetOperationStatusRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                InsightsInsightsGetOperationStatusResponse *model = [[InsightsInsightsGetOperationStatusResponse new] initWithDictionary:class_data];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Insights/GetOperationStatus"] body:jsonString authType:nil authKey:nil];
}
-(void) GetPendingOperations:(InsightsInsightsGetPendingOperationsRequest*)request success:(GetPendingOperationsCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[InsightsInsightsGetPendingOperationsRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                InsightsInsightsGetPendingOperationsResponse *model = [[InsightsInsightsGetPendingOperationsResponse new] initWithDictionary:class_data];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Insights/GetPendingOperations"] body:jsonString authType:nil authKey:nil];
}
-(void) SetPerformance:(InsightsInsightsSetPerformanceRequest*)request success:(SetPerformanceCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[InsightsInsightsSetPerformanceRequest class]];
    ...
    [connection setCompletionBlock:^(id obj, NSError *err) {
        ...
        if (!err) {
            ...
            if (playfab_error != nil) {
                ...
                NSDictionary *class_data = [JSON valueForKey:@"data"];
                InsightsInsightsOperationResponse *model = [[InsightsInsightsOperationResponse new] initWithDictionary:class_data];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Insights/SetPerformance"] body:jsonString authType:nil authKey:nil];
}
-(void) SetStorageRetention:(InsightsInsightsSetStorageRetentionRequest*)request success:(SetStorageRetentionCallback)callback failure:(ErrorCallback)errorCallback withUserData:(NSObject*)userData
{
    ...
    NSString *jsonString = [request JSONStringWithClass:[InsightsInsightsSetStorageRetentionRequest class]];
    ...
    [connection postURL:[NSString stringWithFormat:@"%@%@",[PlayFabClientAPI GetURL],@"/Insights/SetStorageRetention"] body:jsonString authType:nil authKey:nil];
}
